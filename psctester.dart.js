// Generated by dart2js (NullSafetyMode.sound, csp, deferred-serialization, intern-composite-values), the Dart to JavaScript compiler version: 2.19.0-347.0.dev.
...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    show(selector) {
      var t1 = document.querySelector(selector);
      t1.toString;
      J.get$classes$x(t1).remove$1(0, "hidden");
      t1.hidden = false;
    },
    main() {
      var t2, tmx5button, t3, t4, t5, _s5_ = "click",
        t1 = document;
      ...
      $.CurrTest = "";
      A._EventStreamSubscription$(t2._as(t1.querySelector("#test_tmx4")), _s5_, t4._as(new A.main_closure0()), false, t3);
      A._EventStreamSubscription$(t2._as(t1.querySelector("#manage_files")), _s5_, t4._as(new A.main_closure1()), false, t3);
      A._EventStreamSubscription$(t2._as(t1.querySelector("#maintenance")), _s5_, t4._as(new A.main_closure2()), false, t3);
      A._EventStreamSubscription$(window, "resize", type$.nullable_void_Function_Event._as(new A.main_closure3()), false, type$.Event);
      A.checkstatus();
    },
    do_files($event) {
      var t2, returnbutton, t3, t4, t5, modselect, _s5_ = "click",
        t1 = document;
      ...
      A._EventStreamSubscription$(t2._as(t1.querySelector("#download")), _s5_, t4._as(new A.do_files_closure1()), false, t3);
      A._EventStreamSubscription$(t2._as(t1.querySelector("#archive")), _s5_, t4._as(new A.do_files_closure2()), false, t3);
    },
    enableTest() {
      var siteid, t2,
        t1 = document,
    ...
    do_maintenance($event) {
      var t2, settime, t3, t4, t5,
        _s9_ = "#sysmaint",
        _s5_ = "click",
        t1 = document;
      t1.querySelector("#main").hidden = true;
      t1.querySelector("#messageblock").hidden = true;
      t2 = t1.querySelector(_s9_);
      t2.toString;
      J.get$classes$x(t2).remove$1(0, "hidden");
      A.show(_s9_);
      A.showdate("#dt1");
      A.getVersions();
      A.getAddresses();
      ...
      A._EventStreamSubscription$(t2._as(t1.querySelector("#go_main")), _s5_, t4._as(new A.do_maintenance_closure0()), false, t3);
      A._EventStreamSubscription$(t2._as(t1.querySelector("#reinit")), _s5_, t4._as(new A.do_maintenance_closure1()), false, t3);
    },
    getVersions() {
      var s,
        t1 = document,
    ...
    showfiles() {
      var t2, _i, mode, o, downloads,
        _s10_ = "#modselect",
        t1 = document,
        modselect = type$.SelectElement._as(t1.querySelector(_s10_));
      if (modselect.children.length === 0)
        for (t2 = type$.Iterable_String._as($.SelectionModes), _i = 0; _i < 6; ++_i) {
          mode = t2[_i];
      ...
      A.clearFiles();
      downloads = type$.nullable_SelectElement._as(t1.querySelector("#downloads"));
      A.HttpRequest_getString("cgi-bin/fileslist.py").then$1$1(new A.showfiles_closure(downloads), type$.Null);
      A.show(_s10_);
    },
    archiveFiles($event) {
      var t1, theForm, downloads, t2, count, t3, data;
      $event.preventDefault();
      $event.stopPropagation();
      t1 = document;
      theForm = type$.nullable_FormElement._as(t1.querySelector("#filesform"));
      downloads = type$.SelectElement._as(t1.querySelector("#downloads"));
      for (t1 = type$.Iterable_OptionElement._as(new A._ChildrenElementList(downloads, downloads.children)), t1 = t1.toList$0(t1), t2 = A._arrayInstanceType(t1), t1 = new J.ArrayIterator(t1, t1.length, t2._eval$1("ArrayIterator<1>")), t2 = t2._precomputed1, count = 0; t1.moveNext$0();) {
        t3 = t1._current;
        if ((t3 == null ? t2._as(t3) : t3).selected)
          ++count;
      }
    ...
    doFileSelection() {
      var t2, t3, today, lastseven,
        t1 = document,
        downloads = type$.nullable_SelectElement._as(t1.querySelector("#downloads"));
      t1 = type$.SelectElement._as(t1.querySelector("#modselect")).value;
      t2 = $.SelectionModes;
      if (t1 === t2[0])
        for (t1 = type$.Iterable_OptionElement._as(new A._ChildrenElementList(downloads, downloads.children)), t1 = t1.toList$0(t1), t2 = A._arrayInstanceType(t1), t1 = new J.ArrayIterator(t1, t1.length, t2._eval$1("ArrayIterator<1>")), t2 = t2._precomputed1; t1.moveNext$0();) {
          t3 = t1._current;
          (t3 == null ? t2._as(t3) : t3).selected = false;
        }
      else if (t1 === t2[3])
        for (t1 = type$.Iterable_OptionElement._as(new A._ChildrenElementList(downloads, downloads.children)), t1 = t1.toList$0(t1), t2 = A._arrayInstanceType(t1), t1 = new J.ArrayIterator(t1, t1.length, t2._eval$1("ArrayIterator<1>")), t2 = t2._precomputed1; t1.moveNext$0();) {
          t3 = t1._current;
          (t3 == null ? t2._as(t3) : t3).selected = true;
        }
      else if (t1 === t2[1]) {
        downloads.toString;
        ...
        for (t1 = type$.Iterable_OptionElement._as(new A._ChildrenElementList(downloads, downloads.children)), t1 = t1.toList$0(t1), t2 = A._arrayInstanceType(t1), t1 = new J.ArrayIterator(t1, t1.length, t2._eval$1("ArrayIterator<1>")), t2 = t2._precomputed1; t1.moveNext$0();) {
          ...
          if (t3 == null)
            t3 = t2._as(t3);
          if (A.metaParse(t3.value).$index(0, "date") === today)
            t3.selected = true;
          else
            t3.selected = false;
        }
        ...
        for (t1 = type$.Iterable_OptionElement._as(new A._ChildrenElementList(downloads, downloads.children)), t1 = t1.toList$0(t1), t2 = A._arrayInstanceType(t1), t1 = new J.ArrayIterator(t1, t1.length, t2._eval$1("ArrayIterator<1>")), t2 = t2._precomputed1; t1.moveNext$0();) {
          ...
          if (t3 == null)
            t3 = t2._as(t3);
          if (B.JSArray_methods.contains$1(lastseven, A.metaParse(t3.value).$index(0, "date")))
            t3.selected = true;
          else
            t3.selected = false;
        }
    ...
    sortOptions(element, compare) {
      var t1, t2, t3, t4, result, _i, item, o, myList = [];
      for (t1 = element.children, t2 = type$.Iterable_OptionElement._as(new A._ChildrenElementList(element, t1)), t2 = t2.toList$0(t2), t3 = A._arrayInstanceType(t2), t2 = new J.ArrayIterator(t2, t2.length, t3._eval$1("ArrayIterator<1>")), t3 = t3._precomputed1; t2.moveNext$0();) {
        t4 = t2._current;
        myList.push((t4 == null ? t3._as(t4) : t4).value);
      }
      ...
      for (type$.Iterable_String._as(myList), t1 = myList.length, _i = 0; _i < myList.length; myList.length === t1 || (0, A.throwConcurrentModificationError)(myList), ++_i) {
        item = myList[_i];
        o = A.OptionElement_OptionElement$_("", "", null, false);
    ...
    lastSevenDays() {
      ...
      newList = [];
      for (type$.Iterable_DateTime._as(theList), _i = 0; _i < theList.length; theList.length === t2 || (0, A.throwConcurrentModificationError)(theList), ++_i) {
        d = theList[_i];
        newList.push("" + A.Primitives_getYear(d) + B.JSString_methods.padLeft$2("" + A.Primitives_getMonth(d), 2, "0") + B.JSString_methods.padLeft$2("" + A.Primitives_getDay(d), 2, "0"));
      }
      return newList;
    },
    ...
    starttest($event) {
      ...
      if (button.textContent === "New test") {
        ...
        if ($.CurrTest === "tmx4") {
          t1 = t4._as(t1.querySelector("#serial")).value;
          t1.toString;
          serial = B.JSString_methods.padLeft$2(t1, 8, "0");
        } else
          serial = "";
        t1 = type$.dynamic;
  ...
  A.main_closure.prototype = {
    call$1(e) {
      ...
      $.CurrTest = "tmx5";
      t1 = document;
      t2 = t1.querySelector(_s8_);
      t2.toString;
      J.get$classes$x(t2).remove$1(0, "hidden");
      A.enableTest();
      t1.querySelector("#tmx4").hidden = true;
      B.InputElement_methods.set$value(type$.InputElement._as(t1.querySelector("#serial")), "");
      t1.querySelector("#main").hidden = true;
      A.rt_main_enable();
    },
    $signature: 1
  ...
  A.main_closure1.prototype = {
    call$1(e) {
      A.do_files(type$.MouseEvent._as(e));
    },
    $signature: 1
  };
  A.main_closure2.prototype = {
    call$1(e) {
      A.do_maintenance(type$.MouseEvent._as(e));
    },
    $signature: 1
  };
  ...
  A.do_files_closure1.prototype = {
    call$1(e) {
      ...
      if (type$.SelectElement._as(t1.querySelector("#downloads")).value.length === 0) {
        e.preventDefault();
        e.stopPropagation();
  ...
  A.do_maintenance_closure.prototype = {
    call$1(e) {
      A.fix_time(type$.MouseEvent._as(e));
    },
    $signature: 1
  };
  ...
  A.showfiles_closure.prototype = {
    call$1(resp) {
      ...
      for (t1 = J.get$iterator$ax(type$.Iterable_dynamic._as(J.$index$asx(B.C_JsonCodec.decode$2$reviver(0, A._asString(resp), null), "files"))), t2 = this.downloads; t1.moveNext$0();) {
  ...
  A.archiveFiles_closure.prototype = {
    call$1(req) {
      type$.HttpRequest._as(req);
      A.showfiles();
      B.SelectElement_methods.set$selectedIndex(type$.SelectElement._as(document.querySelector("#modselect")), 0);
    },
    $signature: 24
  };
  ...
  A.checkstatus_closure.prototype = {
    call$1(resp) {
      var data, t1, exception, t2, filename, testbutton, form, msgs, z, bell, t, ie, serial, button, _s6_ = "status",
        _s8_ = "filename",
        _s11_ = "#testbutton";
      A._asString(resp);
      t1 = type$.dynamic;
      ...
      if (J.$eq$(J.$index$asx(t2, _s6_), "done") && J.$index$asx(data, _s8_) != null) {
        ...
        if (J.$index$asx(data, "address") != null)
          if ($.CurrTest !== "") {
            ...
            B.InputElement_methods.set$value(t, A._asStringQ(J.$index$asx(data, "address")));
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "date_format_DateFormat_localeExists$closure", "DateFormat_localeExists", 25);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.ConstantMap, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.MapMixin, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A._MatchImplementation, A.Rti, A._FunctionParameters, A._TimerImpl, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A.StreamTransformerBase, A._Zone, A.__SetBase_Object_SetMixin, A._LinkedHashSetCell, A._LinkedHashSetIterator, A._ListBase_Object_ListMixin, A.ListMixin, A.SetMixin, A._SetBase_Object_SetMixin, A.Codec, A._JsonStringifier, A.DateTime, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.CssStyleDeclarationBase, A.EventStreamProvider, A.ImmutableListMixin, A.FixedSizeListIterator, A._DOMWindowCrossFrame, A._LocationCrossFrame, A.NullRejectionException, A.DateSymbols, A.DateFormat, A._DateFormatField, A.UninitializedLocaleData, A.LocaleDataException]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      Iterable_DateTime: findType("Iterable<DateTime>"),
      Iterable_OptionElement: findType("Iterable<OptionElement>"),
      ...
      nullable_FormElement: findType("FormElement?"),
