// Generated by dart2js (NullSafetyMode.unsound, csp, deferred-serialization, intern-composite-values), the Dart to JavaScript compiler version: 2.19.0-347.0.dev.
...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    stringReplaceAllGeneral(receiver, pattern, replacement) {
      var t1, startIndex, t2, t3, t4;
      if (pattern == null)
        A.throwExpression(A.argumentErrorValue(pattern));
      pattern.toString;
      t1 = new A._AllMatchesIterator(pattern, receiver, 0);
      startIndex = 0;
      t2 = "";
      for (; t1.moveNext$0();) {
        t3 = t1.__js_helper$_current._match;
        t4 = t3.index;
        t2 = t2 + receiver.substring(startIndex, t4) + replacement;
    ...
    main() {
      var t2, tmx5button, t3, t4, t5, tmx4button, files, maintenance, _s5_ = "click",
        t1 = document;
      t1.querySelector("#testing").hidden = true;
      t1.querySelector("#sysmaint").hidden = true;
      t1.querySelector("#messageblock").hidden = true;
      A.showdate("#dt");
      t2 = type$.legacy_ButtonElement;
      ...
      $.CurrTest = "";
      tmx4button = t2._as(t1.querySelector("#test_tmx4"));
      tmx4button.toString;
      A._EventStreamSubscription$(tmx4button, _s5_, t4._as(new A.main_closure0()), false, t3);
      files = t2._as(t1.querySelector("#manage_files"));
      files.toString;
      A._EventStreamSubscription$(files, _s5_, t4._as(new A.main_closure1()), false, t3);
      maintenance = t2._as(t1.querySelector("#maintenance"));
      maintenance.toString;
      A._EventStreamSubscription$(maintenance, _s5_, t4._as(new A.main_closure2()), false, t3);
      A._EventStreamSubscription$(window, "resize", type$.nullable_void_Function_legacy_Event._as(new A.main_closure3()), false, type$.legacy_Event);
      A.checkstatus();
    },
    do_files($event) {
      var t2, returnbutton, t3, t4, t5, modselect, download, archive, _s5_ = "click",
        t1 = document;
      t1.querySelector("#main").hidden = true;
      A.show("#files");
      t2 = type$.legacy_ButtonElement;
      returnbutton = t2._as(t1.querySelector("#return_main2"));
      returnbutton.toString;
      t3 = type$._ElementEventStreamImpl_legacy_MouseEvent;
      t4 = t3._eval$1("~(1)?");
      t5 = t4._as(new A.do_files_closure());
      type$.nullable_void_Function._as(null);
      t3 = t3._precomputed1;
      A._EventStreamSubscription$(returnbutton, _s5_, t5, false, t3);
      A.showfiles();
      modselect = type$.legacy_SelectElement._as(t1.querySelector("#modselect"));
      (modselect && B.SelectElement_methods).set$value(modselect, $.SelectionModes[0]);
      t5 = type$._ElementEventStreamImpl_legacy_Event;
      A._EventStreamSubscription$(modselect, "change", t5._eval$1("~(1)?")._as(new A.do_files_closure0()), false, t5._precomputed1);
      download = t2._as(t1.querySelector("#download"));
      download.toString;
      A._EventStreamSubscription$(download, _s5_, t4._as(new A.do_files_closure1()), false, t3);
      archive = t2._as(t1.querySelector("#archive"));
      archive.toString;
      A._EventStreamSubscription$(archive, _s5_, t4._as(new A.do_files_closure2()), false, t3);
    },
    enableTest() {
      var siteid, t2,
        t1 = document,
        testbutton = type$.legacy_ButtonElement._as(t1.querySelector("#testbutton"));
      (testbutton && B.ButtonElement_methods).set$text(testbutton, "Begin test");
      testbutton.disabled = false;
      A.show("#messageblock");
      siteid = type$.legacy_InputElement._as(t1.querySelector("#siteid"));
      (siteid && B.InputElement_methods).set$disabled(siteid, false);
      siteid.focus();
      A.sizeMessageBlock();
    ...
    rt_main_enable() {
      var t1, t2,
        returnbutton = type$.legacy_ButtonElement._as(document.querySelector("#return_main"));
      returnbutton.toString;
      t1 = type$._ElementEventStreamImpl_legacy_MouseEvent;
      t2 = t1._eval$1("~(1)?")._as(new A.rt_main_enable_closure());
      type$.nullable_void_Function._as(null);
      A._EventStreamSubscription$(returnbutton, "click", t2, false, t1._precomputed1);
    },
    do_maintenance($event) {
      var t2, settime, t3, t4, t5, returnbutton, reinitbutton,
        _s9_ = "#sysmaint",
        _s5_ = "click",
        t1 = document;
      t1.querySelector("#main").hidden = true;
      t1.querySelector("#messageblock").hidden = true;
      J.get$classes$x(t1.querySelector(_s9_)).remove$1(0, "hidden");
      A.show(_s9_);
      A.showdate("#dt1");
      A.getVersions();
      A.getAddresses();
      ...
      t3 = type$._ElementEventStreamImpl_legacy_MouseEvent;
      t4 = t3._eval$1("~(1)?");
      t5 = t4._as(new A.do_maintenance_closure());
      type$.nullable_void_Function._as(null);
      t3 = t3._precomputed1;
      A._EventStreamSubscription$(settime, _s5_, t5, false, t3);
      returnbutton = t2._as(t1.querySelector("#go_main"));
      returnbutton.toString;
      A._EventStreamSubscription$(returnbutton, _s5_, t4._as(new A.do_maintenance_closure0()), false, t3);
      reinitbutton = t2._as(t1.querySelector("#reinit"));
      reinitbutton.toString;
      A._EventStreamSubscription$(reinitbutton, _s5_, t4._as(new A.do_maintenance_closure1()), false, t3);
    },
    getVersions() {
      var s,
        t1 = document,
        pretag = type$.legacy_PreElement._as(t1.querySelector("#versions")),
        t2 = type$.Null;
    ...
    getAddresses() {
      var t1, result,
        p = type$.legacy_ParagraphElement._as(document.querySelector("#ip"));
      for (t1 = p.children; t1.length > 0;) {
    ...
    fix_time($event) {
      var t3,
        ...
        t1 = type$.nullable_void_Function_legacy_ProgressEvent,
        t2 = t1._as(new A.fix_time_closure(request, t));
      type$.nullable_void_Function._as(null);
      t3 = type$.legacy_ProgressEvent;
      A._EventStreamSubscription$(request, "loadend", t2, false, t3);
      A._EventStreamSubscription$(request, "timeout", t1._as(new A.fix_time_closure0()), false, t3);
      B.HttpRequest_methods.open$2(request, "POST", "cgi-bin/settime.py");
      request.send(B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["dt", [A.Primitives_getYear(t), A.Primitives_getMonth(t), A.Primitives_getDay(t), A.Primitives_getHours(t), A.Primitives_getMinutes(t), A.Primitives_getSeconds(t), A.Primitives_getMilliseconds(t)]], type$.legacy_String, type$.legacy_List_dynamic), null));
    },
    clearFiles() {
      var t1, result,
        downloads = type$.legacy_SelectElement._as(document.querySelector("#downloads"));
      for (t1 = downloads.children; t1.length > 0;) {
    ...
    showdate(loc) {
      var dt = type$.legacy_SpanElement._as(document.querySelector(loc));
      A.HttpRequest_getString("cgi-bin/getdate.py").then$1$1(new A.showdate_closure(dt), type$.Null);
    },
    showfiles() {
      var t3, _i, t4, o, downloads,
        _s10_ = "#modselect",
        t1 = document,
        t2 = type$.legacy_SelectElement,
        modselect = t2._as(t1.querySelector(_s10_));
      if (modselect.children.length === 0)
        for (t3 = $.SelectionModes, _i = 0; _i < 6; ++_i) {
          t4 = t3[_i];
          o = A.OptionElement_OptionElement$_("", "", null, false);
          B.OptionElement_methods.set$text(o, t4);
          o.value = t4;
          modselect.appendChild(o);
        }
      A.clearFiles();
      downloads = t2._as(t1.querySelector("#downloads"));
      A.HttpRequest_getString("cgi-bin/fileslist.py").then$1$1(new A.showfiles_closure(downloads), type$.Null);
      A.show(_s10_);
    },
    archiveFiles($event) {
      var t1, theForm, downloads, t2, count, data;
      $event.preventDefault();
      $event.stopPropagation();
      t1 = document;
      theForm = type$.legacy_FormElement._as(t1.querySelector("#filesform"));
      downloads = type$.legacy_SelectElement._as(t1.querySelector("#downloads"));
      for (t1 = new A._ChildrenElementList(downloads, downloads.children), t1 = t1.toList$0(t1), t1 = new J.ArrayIterator(t1, t1.length, A._arrayInstanceType(t1)._eval$1("ArrayIterator<1>")), t2 = type$.legacy_OptionElement, count = 0; t1.moveNext$0();)
        if (t2._as(t1._current).selected === true)
          ++count;
      if (B.Window_methods.confirm$1(window, "Moving " + count + " files to Archive. Continue?") === false)
        return;
      data = A.FormData_FormData(theForm);
      A.HttpRequest_request("cgi-bin/archive_files.py", theForm.method, null, data, null).then$1$1(new A.archiveFiles_closure(), type$.Null);
    },
    doFileSelection() {
      var today, o, lastseven,
        t1 = document,
        t2 = type$.legacy_SelectElement,
        downloads = t2._as(t1.querySelector("#downloads"));
      ...
      t2 = $.SelectionModes;
      if (t1 === t2[0])
        for (t1 = new A._ChildrenElementList(downloads, downloads.children), t1 = t1.toList$0(t1), t1 = new J.ArrayIterator(t1, t1.length, A._arrayInstanceType(t1)._eval$1("ArrayIterator<1>")), t2 = type$.legacy_OptionElement; t1.moveNext$0();)
          t2._as(t1._current).selected = false;
      else if (t1 === t2[3])
        for (t1 = new A._ChildrenElementList(downloads, downloads.children), t1 = t1.toList$0(t1), t1 = new J.ArrayIterator(t1, t1.length, A._arrayInstanceType(t1)._eval$1("ArrayIterator<1>")), t2 = type$.legacy_OptionElement; t1.moveNext$0();)
          t2._as(t1._current).selected = true;
      else if (t1 === t2[1]) {
        A.sortOptions(downloads, A.psctester__datesort$closure());
        today = A.sformat(new A.DateTime(Date.now(), false));
        for (t1 = new A._ChildrenElementList(downloads, downloads.children), t1 = t1.toList$0(t1), t1 = new J.ArrayIterator(t1, t1.length, A._arrayInstanceType(t1)._eval$1("ArrayIterator<1>")), t2 = type$.legacy_OptionElement; t1.moveNext$0();) {
          o = t2._as(t1._current);
    ...
    sortOptions(element, compare) {
      var t1, t2, t3, result, _i, o, myList = [];
      for (t1 = element.children, t2 = new A._ChildrenElementList(element, t1), t2 = t2.toList$0(t2), t2 = new J.ArrayIterator(t2, t2.length, A._arrayInstanceType(t2)._eval$1("ArrayIterator<1>")), t3 = type$.legacy_OptionElement; t2.moveNext$0();)
        myList.push(t3._as(t2._current).value);
      ...
      for (t1 = myList.length, _i = 0; _i < myList.length; myList.length === t1 || (0, A.throwConcurrentModificationError)(myList), ++_i) {
        t2 = myList[_i];
        o = A.OptionElement_OptionElement$_("", "", null, false);
        B.OptionElement_methods.set$text(o, t2);
        o.value = t2;
        element.appendChild(o);
      }
    },
    lastSevenDays() {
      var count, t2, t3, newList, _i,
        t1 = Date.now(),
      ...
      for (_i = 0; _i < theList.length; theList.length === t2 || (0, A.throwConcurrentModificationError)(theList), ++_i) {
        t1 = theList[_i];
        newList.push("" + A.Primitives_getYear(t1) + B.JSString_methods.padLeft$2("" + A.Primitives_getMonth(t1), 2, "0") + B.JSString_methods.padLeft$2("" + A.Primitives_getDay(t1), 2, "0"));
      }
      return newList;
    },
    sitesort(elem1, elem2) {
      return J.compareTo$1$ns(A.metaParse(A._asStringS(elem1)).$index(0, "siteid"), A.metaParse(A._asStringS(elem2)).$index(0, "siteid"));
    },
    datesort(elem1, elem2) {
      return -1 * J.compareTo$1$ns(A.metaParse(A._asStringS(elem1)).$index(0, "date"), A.metaParse(A._asStringS(elem2)).$index(0, "date"));
    },
    metaParse(s) {
      var exception,
      ...
      try {
        ...
        if (type$.legacy_RangeError._is(A.unwrapException(exception))) {
    ...
    sformat(adate) {
      adate.toString;
      return "" + A.Primitives_getYear(adate) + B.JSString_methods.padLeft$2("" + A.Primitives_getMonth(adate), 2, "0") + B.JSString_methods.padLeft$2("" + A.Primitives_getDay(adate), 2, "0");
    },
    validateInputs() {
      var siteid, max, min, serial,
        t1 = document,
        t2 = type$.legacy_InputElement,
        t = t2._as(t1.querySelector("#siteid"));
      if (A.Primitives_parseInt(t.value, null) == null)
        return false;
      siteid = t.valueAsNumber;
      max = A.int_parse(t.getAttribute("max"));
      min = A.int_parse(t.getAttribute("min"));
    ...
    starttest($event) {
      var button, t1, t2, t, serial, z, result, ok, request, t3, t4, siteid;
      $event.preventDefault();
      button = type$.legacy_ButtonElement._as(A._convertNativeToDart_EventTarget($event.target));
      if (!A.validateInputs()) {
      ...
      if (button.textContent === "New test") {
        ...
        t2 = type$.legacy_InputElement;
        t = t2._as(t1.querySelector("#siteid"));
        (t && B.InputElement_methods).set$value(t, "");
        B.InputElement_methods.set$disabled(t, false);
        t.focus();
        if ($.CurrTest === "tmx4") {
          serial = t2._as(t1.querySelector("#serial"));
          (serial && B.InputElement_methods).set$disabled(serial, false);
        ...
        A.sizeMessageBlock();
        t1 = document;
        t1.querySelector("#file_available").hidden = true;
        z = type$.legacy_DivElement._as(t1.querySelector("#messages"));
        for (t2 = z.children; t2.length > 0;) {
        ...
        request = new XMLHttpRequest();
        t2 = type$.nullable_void_Function_legacy_ProgressEvent;
        t3 = t2._as(new A.starttest_closure(request));
        type$.nullable_void_Function._as(null);
        t4 = type$.legacy_ProgressEvent;
        A._EventStreamSubscription$(request, "loadend", t3, false, t4);
        A._EventStreamSubscription$(request, "timeout", t2._as(new A.starttest_closure0()), false, t4);
        B.HttpRequest_methods.open$2(request, "POST", "/cgi-bin/dotest.py");
        t4 = type$.legacy_InputElement;
        siteid = t4._as(t1.querySelector("#siteid")).value;
        serial = $.CurrTest === "tmx4" ? J.padLeft$2$s(t4._as(t1.querySelector("#serial")).value, 8, "0") : "";
        t1 = type$.dynamic;
        request.send(B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["siteid", siteid, "address", siteid, "serial", serial], t1, t1), null));
    ...
    sizeMessageBlock() {
      var height, yavailable,
        t1 = document,
        t2 = type$.legacy_DivElement,
        msgs = t2._as(t1.querySelector("#messageblock")),
        testing = t1.querySelector("#testing"),
        $top = t1.querySelector("#top"),
        messageContent = t2._as(t1.querySelector("#messages"));
      t1 = testing.clientHeight;
      t2 = $top.clientHeight;
      if (typeof t1 !== "number")
        return t1.$add();
      if (typeof t2 !== "number")
        return A.iae(t2);
      height = t1 + t2;
      yavailable = window.innerHeight;
      if (typeof yavailable !== "number")
        return yavailable.$sub();
      t2 = msgs.style;
      t2.top = "" + height;
      t1 = messageContent.style;
      t1.height = "" + (yavailable - height - 60) + "px";
    },
    noControlFile($event) {
      B.Window_methods.alert$1(window, A.S($event));
      type$.legacy_ButtonElement._as(document.querySelector("#testbutton")).disabled = false;
      A.Timer_Timer(B.Duration_2000000, A.psctester__checkstatus$closure());
    },
    showmessages(aList) {
      var t2, result, t3, item, t4, starttime, t5, t6, t7, z,
        t1 = document,
        liststart = type$.legacy_DivElement._as(t1.querySelector("#messages"));
      for (t2 = liststart.children; t2.length > 0;) {
        result = liststart.lastElementChild;
        if (result == null)
          A.throwExpression(A.StateError$("No elements"));
        liststart.removeChild(result);
      }
      for (t2 = J.get$iterator$ax(aList), t3 = type$.legacy_List_dynamic; t2.moveNext$0();) {
        item = t2.get$current();
        if (t3._is(item)) {
          t4 = J.getInterceptor$asx(item);
          starttime = A.DateTime_parse(A._asStringS(t4.$index(item, 2))).toLocal$0();
          t5 = Date.now();
          t6 = A._asIntS(t4.$index(item, 1));
          if (typeof t6 !== "number")
            return A.iae(t6);
          t6 = starttime._value + B.JSInt_methods._tdivFast$1(1000000 * t6, 1000);
          t7 = starttime.isUtc;
        ...
        z.appendChild(t1.createTextNode(A._asStringS(item)));
    ...
    do_files_closure: function do_files_closure() {
    },
    do_files_closure0: function do_files_closure0() {
    },
    do_files_closure1: function do_files_closure1() {
    },
    do_files_closure2: function do_files_closure2() {
    },
    enableTest_closure: function enableTest_closure() {
    },
    rt_main_enable_closure: function rt_main_enable_closure() {
    },
    do_maintenance_closure: function do_maintenance_closure() {
    },
    do_maintenance_closure0: function do_maintenance_closure0() {
    },
    do_maintenance_closure1: function do_maintenance_closure1() {
    },
    do_maintenance__closure: function do_maintenance__closure() {
    },
    ...
    fix_time_closure: function fix_time_closure(t0, t1) {
      this.request = t0;
      this.t = t1;
    },
    fix_time_closure0: function fix_time_closure0() {
    },
    showdate_closure: function showdate_closure(t0) {
      this.dt = t0;
    },
    showfiles_closure: function showfiles_closure(t0) {
      this.downloads = t0;
    },
    archiveFiles_closure: function archiveFiles_closure() {
    },
  ...
  A.JSSyntaxRegExp.prototype = {
    ...
    firstMatch$1(string) {
      ...
      if (typeof string != "string")
        A.throwExpression(A.argumentErrorValue(string));
  ...
  A.DateFormat.prototype = {
    format$1(date) {
      ...
      for (; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i)
        t3 += A.S(t1[_i].format$1(date));
      return t3.charCodeAt(0) == 0 ? t3 : t3;
    },
    _appendPattern$2(inputPattern, separator) {
      var t1 = this._date_format$_pattern;
      this._date_format$_pattern = t1 == null ? inputPattern : t1 + separator + A.S(inputPattern);
    },
    addPattern$1(inputPattern) {
      ...
      if (!t3._as(t1).containsKey$1(inputPattern))
        ...
        t1 = $.$get$dateTimePatterns();
        t1.toString;
        _this._appendPattern$2(A._asStringS(t3._as(A.canonicalizedLocale(t2) === "en_US" ? t1.fallbackData : t1._throwException$0()).$index(0, inputPattern)), " ");
      }
      return _this;
    },
    get$dateSymbols() {
    ...
    _localizeDigits$1(numberString) {
      ...
      A.boolConversionCheck(_this.get$useNativeDigits());
  ...
  A.main_closure.prototype = {
    call$1(e) {
      ...
      $.CurrTest = "tmx5";
      t1 = document;
      J.get$classes$x(t1.querySelector(_s8_)).remove$1(0, "hidden");
      A.enableTest();
      t1.querySelector("#tmx4").hidden = true;
      serial = type$.legacy_InputElement._as(t1.querySelector("#serial"));
      (serial && B.InputElement_methods).set$value(serial, "");
      t1.querySelector("#main").hidden = true;
      A.rt_main_enable();
    },
    $signature: 1
  ...
  A.main_closure1.prototype = {
    call$1(e) {
      A.do_files(type$.legacy_MouseEvent._as(e));
    },
    $signature: 1
  };
  A.main_closure2.prototype = {
    call$1(e) {
      A.do_maintenance(type$.legacy_MouseEvent._as(e));
    },
    $signature: 1
  };
  ...
  A.do_files_closure.prototype = {
    call$1(e) {
      type$.legacy_MouseEvent._as(e);
      J.set$href$x(J.get$location$x(A._convertNativeToDart_Window(document.defaultView)), "/");
    },
    $signature: 1
  };
  A.do_files_closure0.prototype = {
    call$1(e) {
      A.doFileSelection();
    },
    $signature: 3
  };
  A.do_files_closure1.prototype = {
    call$1(e) {
      var t1 = document,
        theForm = type$.legacy_FormElement._as(t1.querySelector("#filesform"));
      (theForm && B.FormElement_methods).set$action(theForm, "cgi-bin/get_zip.py");
      if (type$.legacy_SelectElement._as(t1.querySelector("#downloads")).value.length === 0) {
        e.preventDefault();
        e.stopPropagation();
  ...
  A.enableTest_closure.prototype = {
    call$1(e) {
      A.starttest(type$.legacy_MouseEvent._as(e));
    },
    $signature: 1
  };
  A.rt_main_enable_closure.prototype = {
    call$1(e) {
      type$.legacy_MouseEvent._as(e);
      J.set$href$x(J.get$location$x(A._convertNativeToDart_Window(document.defaultView)), "/");
    },
  ...
  A.do_maintenance_closure.prototype = {
    call$1(e) {
      A.fix_time(type$.legacy_MouseEvent._as(e));
    },
    $signature: 1
  };
  A.do_maintenance_closure0.prototype = {
    call$1(e) {
      type$.legacy_MouseEvent._as(e);
      J.set$href$x(J.get$location$x(A._convertNativeToDart_Window(document.defaultView)), "/");
    },
  ...
  A.do_maintenance_closure1.prototype = {
    call$1(e) {
      type$.legacy_MouseEvent._as(e);
      A.HttpRequest_getString("/cgi-bin/initcontrolfile.py").then$1$1(new A.do_maintenance__closure(), type$.Null);
    },
    $signature: 1
  };
  A.do_maintenance__closure.prototype = {
    call$1(resp) {
      A._asStringS(resp);
  ...
  A.getVersions_closure.prototype = {
    call$1(resp) {
      var t1 = this.pretag;
      (t1 && B.PreElement_methods).set$text(t1, A._asStringS(resp));
    },
    $signature: 2
  };
  A.getVersions_closure0.prototype = {
    call$1(resp) {
      J.set$text$x(this.s, B.JSString_methods.$add("Software versions: ( ", A._asStringS(resp)) + " )");
    },
    $signature: 2
  };
  A.getAddresses_closure.prototype = {
    call$1(resp) {
      var t1, t2, item, address, t3,
        j = type$.legacy_Map_dynamic_dynamic._as(B.C_JsonCodec.decode$2$reviver(0, A._asStringS(resp), null));
      for (t1 = J.get$iterator$ax(j.get$keys()), t2 = this.p; t1.moveNext$0();) {
        item = A._asStringS(t1.get$current());
        address = A._asStringS(j.$index(0, item));
        if (0 >= item.length)
          return A.ioore(item, 0);
        t3 = A.S(address);
        if (item[0] === "w") {
          t2.toString;
          t2.appendChild(document.createTextNode("Wireless: " + t3 + " "));
        } else {
          t2.toString;
          t2.appendChild(document.createTextNode("Wired: " + t3 + " "));
        }
  ...
  A.fix_time_closure.prototype = {
    call$1(e) {
      type$.legacy_ProgressEvent._as(e);
      if (J.$eq$(type$.legacy_Map_dynamic_dynamic._as(B.C_JsonCodec.decode$2$reviver(0, this.request.responseText, null)).$index(0, "resp"), true)) {
        A.showdate("#dt1");
  ...
  A.showdate_closure.prototype = {
    call$1(resp) {
      var value = A.DateTime_parse(A._asStringS(J.$index$asx(B.C_JsonCodec.decode$2$reviver(0, A._asStringS(resp), null), "datetime"))).toLocal$0(),
        t1 = this.dt;
      (t1 && B.SpanElement_methods).set$text(t1, A.DateFormat$yMEd().addPattern$1("jms").format$1(value));
    },
    $signature: 2
  };
  A.showfiles_closure.prototype = {
    call$1(resp) {
      var t1, t2, filename, o;
      for (t1 = J.get$iterator$ax(type$.legacy_Iterable_dynamic._as(J.$index$asx(B.C_JsonCodec.decode$2$reviver(0, A._asStringS(resp), null), "files"))), t2 = this.downloads; t1.moveNext$0();) {
        filename = A._asStringS(t1.get$current());
        o = A.OptionElement_OptionElement$_("", "", null, false);
  ...
  A.archiveFiles_closure.prototype = {
    call$1(req) {
      var modselect;
      type$.legacy_HttpRequest._as(req);
      A.showfiles();
      modselect = type$.legacy_SelectElement._as(document.querySelector("#modselect"));
      (modselect && B.SelectElement_methods).set$selectedIndex(modselect, 0);
    },
    $signature: 26
  };
  ...
  A.checkstatus_closure.prototype = {
    call$1(resp) {
      var data, t1, exception, filename, t2, testbutton, form, msgs, z, bell, t, ie, serial, button, _s6_ = "status",
        _s8_ = "filename",
        _s11_ = "#testbutton";
      A._asStringS(resp);
      t1 = type$.dynamic;
      data = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      try {
        data = type$.legacy_Map_dynamic_dynamic._as(B.C_JsonCodec.decode$2$reviver(0, resp, null));
      } catch (exception) {
      ...
      if (J.$eq$(J.$index$asx(data, _s6_), "done") && J.$index$asx(data, _s8_) != null) {
        filename = A._asStringS(J.$index$asx(data, _s8_));
        A.show("#file_available");
        t2 = document;
        testbutton = type$.legacy_ButtonElement._as(t2.querySelector(_s11_));
        (testbutton && B.ButtonElement_methods).set$text(testbutton, "New test");
        testbutton.disabled = false;
        form = type$.legacy_FormElement._as(t2.querySelector("#download_latest"));
        (form && B.FormElement_methods).set$method(form, "POST");
        B.FormElement_methods.set$action(form, "cgi-bin/getfile.py?filename=" + A.S(filename));
        msgs = type$.legacy_DivElement._as(t2.querySelector("#messages"));
        A.sizeMessageBlock();
        if (msgs.children.length > 0) {
          ...
          msgs.appendChild(z);
          B.ParagraphElement_methods.scrollIntoView$0(z);
          bell = type$.legacy_AudioElement._as(t2.querySelector("#bell"));
          if (bell != null)
        ...
        A.showmessages(type$.legacy_List_dynamic._as(J.$index$asx(data, "messages")));
        if (J.$index$asx(data, "address") != null)
          if ($.CurrTest !== "") {
            t1 = document;
            t2 = type$.legacy_InputElement;
            t = t2._as(t1.querySelector("#siteid"));
            (t && B.InputElement_methods).set$value(t, A._asStringS(J.$index$asx(data, "address")));
            B.InputElement_methods.set$disabled(t, true);
            if ($.CurrTest === "tmx4") {
              ie = t2._as(t1.querySelector("#serial"));
              if (ie != null) {
                serial = J.$index$asx(data, "serial");
                if (serial != null && !J.$eq$(serial, ""))
                  B.InputElement_methods.set$value(ie, A._asStringS(serial));
                B.InputElement_methods.set$disabled(ie, true);
              }
            }
            button = type$.legacy_ButtonElement._as(t1.querySelector(_s11_));
            if (button != null) {
              B.ButtonElement_methods.set$text(button, "Test in progress");
              button.disabled = true;
            }
      ...
      testbutton = type$.legacy_ButtonElement._as(document.querySelector(_s11_));
      (testbutton && B.ButtonElement_methods).set$text(testbutton, "Retry");
      testbutton.disabled = false;
    },
    $signature: 2
  };
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "date_format_DateFormat_localeExists$closure", "DateFormat_localeExists", 27);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.ConstantMap, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.MapMixin, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._AllMatchesIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A.StreamTransformerBase, A._Zone, A.__SetBase_Object_SetMixin, A._LinkedHashSetCell, A._LinkedHashSetIterator, A._ListBase_Object_ListMixin, A.ListMixin, A.SetMixin, A._SetBase_Object_SetMixin, A.Codec, A._JsonStringifier, A.DateTime, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.CssStyleDeclarationBase, A.EventStreamProvider, A.ImmutableListMixin, A.FixedSizeListIterator, A._DOMWindowCrossFrame, A._LocationCrossFrame, A.NullRejectionException, A.DateSymbols, A.DateFormat, A._DateFormatField, A.UninitializedLocaleData, A.LocaleDataException]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, A.EventTarget, A._CssStyleDeclaration_JavaScriptObject_CssStyleDeclarationBase, A.DomException, A.DomTokenList, A.Event, A._HtmlCollection_JavaScriptObject_ListMixin, A.Location, A.__NamedNodeMap_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A.DateTime_parse_parseIntOrZero, A.DateTime_parse_parseMilliAndMicroseconds, A.HttpRequest_getString_closure, A.HttpRequest_request_closure, A._EventStreamSubscription_closure, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.DateFormat_dateTimeConstructor_closure, A.main_closure, A.main_closure0, A.main_closure1, A.main_closure2, A.main_closure3, A.do_files_closure, A.do_files_closure0, A.do_files_closure1, A.do_files_closure2, A.enableTest_closure, A.rt_main_enable_closure, A.do_maintenance_closure, A.do_maintenance_closure0, A.do_maintenance_closure1, A.do_maintenance__closure, A.getVersions_closure, A.getVersions_closure0, A.getAddresses_closure, A.fix_time_closure, A.fix_time_closure0, A.showdate_closure, A.showfiles_closure, A.archiveFiles_closure, A.starttest_closure, A.starttest_closure0, A.checkstatus_closure]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inherit(A._AssertionError, A.AssertionError);
    _inherit(A.MapBase, A.MapMixin);
    _inheritMany(A.MapBase, [A.JsLinkedHashMap, A._JsonMap]);
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._Future__chainForeignFuture_closure0, A.MapBase_mapToString_closure, A._JsonStringifier_writeMap_closure, A.DateFormat__fieldConstructors_closure, A.DateFormat__fieldConstructors_closure0, A.DateFormat__fieldConstructors_closure1]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null(MouseEvent*)", "Null(String*)", "Null(Event*)", "Null(ProgressEvent*)", "@(@)", "~(~())", "Null(@)", "Null()", "~(Object?,Object?)", "int(String?)", "~(@)", "int*(@,@)", "@(@,String)", "@(String)", "Null(~())", "~(Object[StackTrace?])", "Null(Object,StackTrace)", "_Future<@>(@)", "String(HttpRequest)", "~(ProgressEvent)", "~(Event)", "DateTime(int,int,int,int,int,int,int,bool)", "_DateFormatQuotedField(String,DateFormat)", "_DateFormatPatternField(String,DateFormat)", "_DateFormatLiteralField(String,DateFormat)", "Null(HttpRequest*)", "bool(@)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","OpenDBRequest":"EventTarget","Request":"EventTarget","_ResourceProgressEvent":"ProgressEvent","BRElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","PointerEvent":"MouseEvent","VideoElement":"MediaElement","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","MathMLElement":"Element","HtmlFormControlsCollection":"HtmlCollection","JSBool":{"bool":[]},"JSNull":{"Null":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSNumNotInt":{"num":[]},"JSString":{"String":[],"Pattern":[]},"LateError":{"Error":[]},"ReachabilityError":{"Error":[]},"NotNullableError":{"TypeError":[],"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"ReversedListIterable":{"ListIterable":["1"],"Iterable":["1"],"ListIterable.E":"1"},"ConstantMap":{"Map":["1","2"]},"ConstantStringMap":{"ConstantMap":["1","2"],"Map":["1","2"]},"_ConstantMapKeyIterable":{"Iterable":["1"]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapMixin":["1","2"],"LinkedHashMap":["1","2"],"Map":["1","2"],"MapMixin.K":"1","MapMixin.V":"2"},"LinkedHashMapKeyIterable":{"Iterable":["1"]},"JSSyntaxRegExp":{"RegExp":[],"Pattern":[]},"_MatchImplementation":{"RegExpMatch":[]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_AsyncCompleter":{"_Completer":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"_LinkedHashSet":{"SetMixin":["1"],"Set":["1"],"Iterable":["1"]},"ListBase":{"ListMixin":["1"],"List":["1"],"Iterable":["1"]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"SetBase":{"SetMixin":["1"],"Set":["1"],"Iterable":["1"]},"_SetBase":{"SetMixin":["1"],"Set":["1"],"Iterable":["1"]},"_JsonMap":{"MapMixin":["String","@"],"Map":["String","@"],"MapMixin.K":"String","MapMixin.V":"@"},"_JsonMapKeyIterable":{"ListIterable":["String"],"Iterable":["String"],"ListIterable.E":"String"},"JsonUnsupportedObjectError":{"Error":[]},"JsonCyclicError":{"Error":[]},"JsonEncoder":{"Converter":["Object?","String"]},"JsonDecoder":{"Converter":["String","Object?"]},"int":{"num":[]},"List":{"Iterable":["1"]},"RegExp":{"Pattern":[]},"String":{"Pattern":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"RangeError":[],"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"StringBuffer":{"StringSink":[]},"Element":{"Node":[],"EventTarget":[]},"HttpRequest":{"EventTarget":[]},"MouseEvent":{"Event":[]},"Node":{"EventTarget":[]},"ProgressEvent":{"Event":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[]},"AudioElement":{"Element":[],"Node":[],"EventTarget":[]},"ButtonElement":{"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"DivElement":{"Element":[],"Node":[],"EventTarget":[]},"_ChildrenElementList":{"ListMixin":["Element"],"List":["Element"],"Iterable":["Element"],"ListMixin.E":"Element"},"FormElement":{"Element":[],"Node":[],"EventTarget":[]},"HtmlCollection":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListMixin.E":"Node","ImmutableListMixin.E":"Node"},"HttpRequestEventTarget":{"EventTarget":[]},"InputElement":{"Element":[],"Node":[],"EventTarget":[]},"MediaElement":{"Element":[],"Node":[],"EventTarget":[]},"OptionElement":{"Element":[],"Node":[],"EventTarget":[]},"ParagraphElement":{"Element":[],"Node":[],"EventTarget":[]},"PreElement":{"Element":[],"Node":[],"EventTarget":[]},"SelectElement":{"Element":[],"Node":[],"EventTarget":[]},"SpanElement":{"Element":[],"Node":[],"EventTarget":[]},"UIEvent":{"Event":[]},"Window":{"WindowBase":[],"EventTarget":[]},"_NamedNodeMap":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListMixin.E":"Node","ImmutableListMixin.E":"Node"},"_ElementCssClassSet":{"SetMixin":["String"],"Set":["String"],"Iterable":["String"]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"_DOMWindowCrossFrame":{"WindowBase":[],"EventTarget":[]},"CssClassSetImpl":{"SetMixin":["String"],"Set":["String"],"Iterable":["String"]},"AttributeClassSet":{"SetMixin":["String"],"Set":["String"],"Iterable":["String"]},"SvgElement":{"Element":[],"Node":[],"EventTarget":[]},"_DateFormatLiteralField":{"_DateFormatField":[]},"_DateFormatQuotedField":{"_DateFormatField":[]},"_DateFormatPatternField":{"_DateFormatField":[]}}'));
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"EfficientLengthIterable":1,"StreamSubscription":1,"StreamTransformerBase":2,"ListBase":1,"MapBase":2,"SetBase":1,"_SetBase":1,"_ListBase_Object_ListMixin":1,"_SetBase_Object_SetMixin":1,"__SetBase_Object_SetMixin":1,"Codec":2}'));
  var string$ = {
...
;
    ...
    B.List_3US = A._setArrayType(makeConstList(["S", "M", "T", "W", "T", "F", "S"]), type$.JSArray_legacy_String);
    B.List_6xs = A._setArrayType(makeConstList(["Before Christ", "Anno Domini"]), type$.JSArray_legacy_String);
    B.List_AM_PM = A._setArrayType(makeConstList(["AM", "PM"]), type$.JSArray_legacy_String);
    B.List_BC_AD = A._setArrayType(makeConstList(["BC", "AD"]), type$.JSArray_legacy_String);
    B.List_Q1_Q2_Q3_Q4 = A._setArrayType(makeConstList(["Q1", "Q2", "Q3", "Q4"]), type$.JSArray_legacy_String);
    B.List_bJM = A._setArrayType(makeConstList(["1st quarter", "2nd quarter", "3rd quarter", "4th quarter"]), type$.JSArray_legacy_String);
    B.List_cIc = A._setArrayType(makeConstList(["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]), type$.JSArray_legacy_String);
    B.List_gc6 = A._setArrayType(makeConstList(["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"]), type$.JSArray_legacy_String);
    B.List_h8w = A._setArrayType(makeConstList(["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]), type$.JSArray_legacy_String);
    B.List_qpm = A._setArrayType(makeConstList(["J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"]), type$.JSArray_legacy_String);
    B.List_wMy = A._setArrayType(makeConstList(["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]), type$.JSArray_legacy_String);
    B.List_EQM = A._setArrayType(makeConstList(["d", "E", "EEEE", "LLL", "LLLL", "M", "Md", "MEd", "MMM", "MMMd", "MMMEd", "MMMM", "MMMMd", "MMMMEEEEd", "QQQ", "QQQQ", "y", "yM", "yMd", "yMEd", "yMMM", "yMMMd", "yMMMEd", "yMMMM", "yMMMMd", "yMMMMEEEEd", "yQQQ", "yQQQQ", "H", "Hm", "Hms", "j", "jm", "jms", "jmv", "jmz", "jz", "m", "ms", "s", "v", "z", "zzzz", "ZZZZ"]), type$.JSArray_legacy_String);
  ...
  (function staticFields() {
    ...
    $.CurrTest = "";
    $.SelectionModes = ["select none", "today", "the last seven days", "select all", "sort by siteid", "invert selection"];
  })();
