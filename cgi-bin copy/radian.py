...
VERSION = 2.02  # Add support for Q family
...
#            print("Warning - no handler for receive packet type {}".format(self.__in_packet__.p_type))
    ...
    def start_accumulating(self):
        """ Tell Radian to accumulate unconditionally"""
        self.send_cmd("Start Accumulating Metrics",b'\x01\x00\x00')   # setup to start accumlating now
