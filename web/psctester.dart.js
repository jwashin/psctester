...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    hide(selector) {
      var item = A._asJSObjectQ(A._asJSObject(init.G.document).querySelector(selector));
      if (item == null)
        item = A._asJSObject(item);
      item.ariaHidden = "true";
      A._asJSObject(item.classList).add("hidden");
    },
    show(selector) {
      var item = A._asJSObjectQ(A._asJSObject(init.G.document).querySelector(selector));
      if (item == null)
      ...
      A._asJSObject(item.classList).remove("hidden");
    },
    main() {
      var t1, tmx5button, t2, t3, tmx5nbutton, qfambutton, tmx4button, tmx1button, tmx3button, files, maintenance, _s5_ = "click";
      $.currTest = "";
      A.hide("#testing");
      A.hide("#sysmaint");
      A.hide("#messageblock");
      A.showdate("#dt");
      t1 = init.G;
      tmx5button = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#test_tmx5"));
      if (tmx5button == null)
        tmx5button = A._asJSObject(tmx5button);
      t2 = type$._ElementEventStreamImpl_JSObject;
      t3 = t2._eval$1("~(1)?");
      t2 = t2._precomputed1;
      A._EventStreamSubscription$(tmx5button, _s5_, t3._as(new A.main_closure()), false, t2);
      tmx5nbutton = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#test_tmx5n"));
      if (tmx5nbutton == null)
        tmx5nbutton = A._asJSObject(tmx5nbutton);
      A._EventStreamSubscription$(tmx5nbutton, _s5_, t3._as(new A.main_closure0()), false, t2);
      qfambutton = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#test_Qfam"));
      if (qfambutton == null)
        qfambutton = A._asJSObject(qfambutton);
      A._EventStreamSubscription$(qfambutton, _s5_, t3._as(new A.main_closure1()), false, t2);
      tmx4button = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#test_tmx4"));
      if (tmx4button == null)
        tmx4button = A._asJSObject(tmx4button);
      A._EventStreamSubscription$(tmx4button, _s5_, t3._as(new A.main_closure2()), false, t2);
      tmx1button = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#test_tmx1"));
      if (tmx1button == null)
        tmx1button = A._asJSObject(tmx1button);
      A._EventStreamSubscription$(tmx1button, _s5_, t3._as(new A.main_closure3()), false, t2);
      tmx3button = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#test_tmx3"));
      if (tmx3button == null)
        tmx3button = A._asJSObject(tmx3button);
      A._EventStreamSubscription$(tmx3button, _s5_, t3._as(new A.main_closure4()), false, t2);
      files = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#manage_files"));
      if (files == null)
        files = A._asJSObject(files);
      A._EventStreamSubscription$(files, _s5_, t3._as(new A.main_closure5()), false, t2);
      maintenance = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#maintenance"));
      if (maintenance == null)
        maintenance = A._asJSObject(maintenance);
      A._EventStreamSubscription$(maintenance, _s5_, t3._as(new A.main_closure6()), false, t2);
      A.checkstatus();
    },
    doFiles($event) {
      var t1, returnbutton, t2, t3, modselect, download, archive, _s5_ = "click";
      A.hide("#main");
      A.show("#files");
      t1 = init.G;
      returnbutton = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#return_main2"));
      if (returnbutton == null)
        returnbutton = A._asJSObject(returnbutton);
      t2 = type$._ElementEventStreamImpl_JSObject;
      t3 = t2._eval$1("~(1)?");
      t2 = t2._precomputed1;
      A._EventStreamSubscription$(returnbutton, _s5_, t3._as(new A.doFiles_closure()), false, t2);
      A.showfiles();
      modselect = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#modselect"));
      if (modselect == null)
        modselect = A._asJSObject(modselect);
      modselect.value = $.selectionModes[0];
      A._EventStreamSubscription$(modselect, "change", t3._as(new A.doFiles_closure0()), false, t2);
      download = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#download"));
      if (download == null)
        download = A._asJSObject(download);
      A._EventStreamSubscription$(download, _s5_, t3._as(new A.doFiles_closure1()), false, t2);
      archive = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#archive"));
      if (archive == null)
        archive = A._asJSObject(archive);
      A._EventStreamSubscription$(archive, _s5_, t3._as(new A.doFiles_closure2()), false, t2);
    },
    enableTest() {
      var siteid,
        t1 = init.G,
      ...
      A.show("#messageblock");
      siteid = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#siteid"));
      if (siteid == null)
        siteid = A._asJSObject(siteid);
      siteid.disabled = false;
      siteid.focus();
      A.sizeMessageBlock();
      t1 = type$._ElementEventStreamImpl_JSObject;
      A._EventStreamSubscription$(testbutton, "click", t1._eval$1("~(1)?")._as(new A.enableTest_closure()), false, t1._precomputed1);
    },
    rtMainEnable() {
      var t1,
        returnbutton = A._asJSObjectQ(A._asJSObject(init.G.document).querySelector("#return_main"));
      if (returnbutton == null)
        returnbutton = A._asJSObject(returnbutton);
      t1 = type$._ElementEventStreamImpl_JSObject;
      A._EventStreamSubscription$(returnbutton, "click", t1._eval$1("~(1)?")._as(new A.rtMainEnable_closure()), false, t1._precomputed1);
    },
    doMaintenance($event) {
      var t1, maint, settime, t2, t3, returnbutton, reinitbutton, _s5_ = "click";
      A.hide("#main");
      A.hide("#messageblock");
      t1 = init.G;
      maint = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#sysmaint"));
      if (maint == null)
        maint = A._asJSObject(maint);
      A._asJSObject(maint.classList).remove("hidden");
      A.show("#sysmaint");
      A.showdate("#dt1");
      A.getVersions();
      A.getAddresses();
      settime = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#time_fix"));
      if (settime == null)
        settime = A._asJSObject(settime);
      t2 = type$._ElementEventStreamImpl_JSObject;
      t3 = t2._eval$1("~(1)?");
      t2 = t2._precomputed1;
      A._EventStreamSubscription$(settime, _s5_, t3._as(new A.doMaintenance_closure()), false, t2);
      returnbutton = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#go_main"));
      if (returnbutton == null)
        returnbutton = A._asJSObject(returnbutton);
      A._EventStreamSubscription$(returnbutton, _s5_, t3._as(new A.doMaintenance_closure0()), false, t2);
      reinitbutton = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#reinit"));
      if (reinitbutton == null)
        reinitbutton = A._asJSObject(reinitbutton);
      A._EventStreamSubscription$(reinitbutton, _s5_, t3._as(new A.doMaintenance_closure1()), false, t2);
    },
    getVersions() {
      var t2, s,
        uri = A.Uri_parse("/script_ver"),
        t1 = init.G,
        pretag = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#versions"));
      if (pretag == null)
        pretag = A._asJSObject(pretag);
      t2 = type$.Null;
      A.get(uri).then$1$1(new A.getVersions_closure(pretag), t2);
      s = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#swver"));
      A.get(A.Uri_parse("/version_tag.txt")).then$1$1(new A.getVersions_closure0(s), t2);
    },
    getAddresses() {
      var t1,
        p = A._asJSObjectQ(A._asJSObject(init.G.document).querySelector("#ip"));
      if (p == null)
        p = A._asJSObject(p);
      while (A._asJSObjectQ(p.firstElementChild) != null) {
        t1 = A._asJSObjectQ(p.firstElementChild);
        if (t1 != null)
          t1.remove();
      }
      A.get(A.Uri_parse("/cgi-bin/ip_addr.py")).then$1$1(new A.getAddresses_closure(p), type$.Null);
    },
    fixTime($event) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], response, j, exception, t, path, t1, out, $async$exception;
      var $async$fixTime = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t = new A.DateTime(Date.now(), 0, false).toUtc$0();
              path = A.Uri_parse("/cgi-bin/settime.py");
              t1 = type$.String;
              out = B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["dt", [A.Primitives_getYear(t), A.Primitives_getMonth(t), A.Primitives_getDay(t), A.Primitives_getHours(t), A.Primitives_getMinutes(t), A.Primitives_getSeconds(t), A.Primitives_getMilliseconds(t)]], t1, type$.List_dynamic), null);
              $async$handler = 3;
              $async$goto = 6;
              return A._asyncAwait(A.post(path, out, A.LinkedHashMap_LinkedHashMap$_literal(["Content-Type", "application/json"], t1, t1)), $async$fixTime);
            case 6:
              // returning from await.
              ...
              if (response.statusCode === 200)
                try {
                  t1 = response;
                  j = type$.Map_dynamic_dynamic._as(B.C_JsonCodec.decode$2$reviver(A.encodingForContentTypeHeader(A._contentTypeForHeaders(t1.headers)).decode$1(t1.bodyBytes), null));
                  t1 = init.G;
                  if (J.$eq$(J.$index$asx(j, "resp"), true)) {
                    A.showdate("#dt1");
                    A._asJSObject(t1.window).alert("System time updated to " + t.toLocal$0().toString$0(0) + "!");
                  } else
                    A._asJSObject(t1.window).alert("time update failed!");
                } catch (exception) {
                  if (type$.FormatException._is(A.unwrapException(exception)))
                    A._asJSObject(init.G.window).alert("Invalid response from server when setting time.");
                  else
                    throw exception;
                }
              else
                A._asJSObject(init.G.window).alert("Error setting time: " + response.statusCode);
              $async$handler = 1;
              // goto after finally
              $async$goto = 5;
              break;
            case 3:
              ...
              $async$handler = 2;
              $async$exception = $async$errorStack.pop();
              A._asJSObject(init.G.window).alert("main script timed out (harmless)");
              // goto after finally
              $async$goto = 5;
              break;
            case 2:
      ...
      return A._asyncStartSync($async$fixTime, $async$completer);
    },
    clearFiles() {
      var t1,
        downloads = A._asJSObjectQ(A._asJSObject(init.G.document).querySelector("#downloads"));
      if (downloads == null)
        downloads = A._asJSObject(downloads);
      while (A._asJSObjectQ(downloads.firstElementChild) != null) {
        t1 = A._asJSObjectQ(downloads.firstElementChild);
        if (t1 != null)
          t1.remove();
      }
    },
    showdate(loc) {
      var path = A.Uri_parse("/cgi-bin/getdate.py"),
        dt = A._asJSObjectQ(A._asJSObject(init.G.document).querySelector(loc));
      A.get(path).then$1$1(new A.showdate_closure(dt), type$.Null);
    },
    showfiles() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        _i, mode, _this, downloads, resp, t2, filename, path, t1, modselect;
      var $async$showfiles = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              path = A.Uri_parse("cgi-bin/fileslist.py");
              t1 = init.G;
              modselect = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#modselect"));
              if (modselect == null)
                modselect = A._asJSObject(modselect);
              if (A._asInt(A._asJSObject(modselect.options).length) === 0)
                for (_i = 0; _i < 6; ++_i) {
                  mode = $.selectionModes[_i];
                  _this = A._asJSObject(A._asJSObject(t1.document).createElement("option"));
                  _this.text = mode;
                  _this.value = mode;
                  A._asJSObject(modselect.options).add(_this);
                }
              A.clearFiles();
              downloads = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#downloads"));
              if (downloads == null)
                downloads = A._asJSObject(downloads);
              $async$goto = 2;
              return A._asyncAwait(A.get(path), $async$showfiles);
            case 2:
              // returning from await.
              resp = $async$result;
              for (t2 = J.get$iterator$ax(type$.Iterable_dynamic._as(J.$index$asx(B.C_JsonCodec.decode$2$reviver(A.encodingForContentTypeHeader(A._contentTypeForHeaders(resp.headers)).decode$1(resp.bodyBytes), null), "files"))); t2.moveNext$0();) {
                filename = A._asString(t2.get$current());
                _this = A._asJSObject(A._asJSObject(t1.document).createElement("option"));
                _this.text = filename;
                _this.value = filename;
                A._asJSObject(downloads.options).add(_this);
              }
              A.show("#modselect");
              // implicit return
              return A._asyncReturn(null, $async$completer);
    ...
    archiveFiles($event) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, t1, theForm, action, downloads, count, modselect;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t1 = init.G;
              theForm = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#filesform"));
              if (theForm == null)
                theForm = A._asJSObject(theForm);
              action = A.Uri_parse("/cgi-bin/archive_files.py");
              downloads = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#downloads"));
              if (downloads == null)
                downloads = A._asJSObject(downloads);
              count = A._asInt(A._asJSObject(downloads.selectedOptions).length);
              $async$goto = count >= 1 ? 3 : 4;
              break;
            case 3:
              // then
              if (!A._asBool(A._asJSObject(t1.window).confirm("Moving " + count + " files to Archive. Continue?"))) {
                // goto return
                $async$goto = 1;
                break;
              }
              $async$goto = 5;
              return A._asyncAwait(A.post(action, A._asJSObject(new t1.FormData(theForm)), null), $async$archiveFiles);
            case 5:
              // returning from await.
              A.showfiles();
              modselect = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#modselect"));
    ...
    doFileSelection() {
      var modselect, i, o, today, lastseven,
        t1 = init.G,
        downloads = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#downloads"));
      if (downloads == null)
        downloads = A._asJSObject(downloads);
      ...
      if (A._asString(modselect.value) === $.selectionModes[0])
        downloads.selectedIndex = -1;
      else if (A._asString(modselect.value) === $.selectionModes[3])
        for (i = 0; i < A._asInt(A._asJSObject(downloads.options).length); ++i) {
          o = A._asJSObjectQ(A._asJSObject(downloads.options).item(i));
          if (o == null)
            o = A._asJSObject(o);
          o.selected = true;
        }
      else if (A._asString(modselect.value) === $.selectionModes[1]) {
        A.sortOptions(downloads, A.psctester__datesort$closure());
        today = A.sformat(new A.DateTime(Date.now(), 0, false));
        for (i = 0; i < A._asInt(A._asJSObject(downloads.options).length); ++i) {
          o = A._asJSObjectQ(A._asJSObject(downloads.options).item(i));
          if (o == null)
            o = A._asJSObject(o);
          if (J.$eq$(A.metaParse(A._asString(o.value)).$index(0, "date"), today))
            o.selected = true;
          else
            o.selected = false;
        }
      } else if (A._asString(modselect.value) === $.selectionModes[2]) {
        A.sortOptions(downloads, A.psctester__datesort$closure());
        ...
        for (i = 0; i < A._asInt(A._asJSObject(downloads.options).length); ++i) {
          ...
          if (o == null)
            o = A._asJSObject(o);
          if (B.JSArray_methods.contains$1(lastseven, A.metaParse(A._asString(o.value)).$index(0, "date")))
            o.selected = true;
          else
            o.selected = false;
        }
      } else if (A._asString(modselect.value) === $.selectionModes[4])
        A.sortOptions(downloads, A.psctester__sitesort$closure());
      else if (A._asString(modselect.value) === $.selectionModes[5])
        for (i = 0; i < A._asInt(A._asJSObject(downloads.options).length); ++i) {
          o = A._asJSObjectQ(A._asJSObject(downloads.options).item(i));
          if (o == null)
            o = A._asJSObject(o);
          if (A._asBool(o.selected))
            o.selected = false;
          else
            o.selected = true;
        }
    ...
    sortOptions(element, compare) {
      var i, item, t1, t2, _i, _this, myList = [];
      for (i = 0; i < A._asInt(A._asJSObject(element.options).length); ++i) {
        item = A._asJSObjectQ(A._asJSObject(element.options).item(i));
        if (item == null)
          item = A._asJSObject(item);
        myList.push(A._asString(item.value));
      }
      B.JSArray_methods.sort$1(myList, compare);
      while (A._asJSObjectQ(element.firstElementChild) != null) {
        t1 = A._asJSObjectQ(element.firstElementChild);
        if (t1 != null)
          t1.remove();
      }
      for (t1 = myList.length, t2 = init.G, _i = 0; _i < myList.length; myList.length === t1 || (0, A.throwConcurrentModificationError)(myList), ++_i) {
        item = myList[_i];
        _this = A._asJSObject(A._asJSObject(t2.document).createElement("option"));
        _this.text = item;
        _this.value = item;
        A._asJSObject(element.options).add(_this);
      }
    },
    lastSevenDays() {
      var count, t1, newList, _i, d,
        today = new A.DateTime(Date.now(), 0, false),
        theList = [today];
      for (count = 1; t1 = theList.length, t1 < 7;) {
        theList.push(today._addMicroseconds$1(0 - 864e8 * count));
        ++count;
      }
      newList = [];
      for (_i = 0; _i < theList.length; theList.length === t1 || (0, A.throwConcurrentModificationError)(theList), ++_i) {
        d = theList[_i];
    ...
    validateInputs() {
      var max, min, siteid, serial, _null = null,
        t1 = init.G,
        t = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#siteid"));
      if (t == null)
        t = A._asJSObject(t);
      max = A.Primitives_parseInt(A._asString(t.max), _null);
      min = A.Primitives_parseInt(A._asString(t.min), _null);
      if (A.Primitives_parseInt(A._asString(t.value), _null) == null)
        return false;
      siteid = B.JSNumber_methods.toInt$0(A._asDouble(t.valueAsNumber));
      ...
      if (B.JSArray_methods.contains$1(A._setArrayType(["tmx4", "tmx3", "tmx1"], type$.JSArray_String), $.currTest)) {
        t = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#serial"));
        if (t == null)
          t = A._asJSObject(t);
        max = A.Primitives_parseInt(A._asString(t.max), _null);
        min = A.Primitives_parseInt(A._asString(t.min), _null);
        if (A.Primitives_parseInt(A._asString(t.value), _null) == null)
          return false;
        serial = A._asDouble(t.valueAsNumber);
    ...
    getInputs() {
      var siteid, t2, out, s, x3, chv, _i,
        t1 = init.G,
        t = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#siteid"));
      if (t == null)
        t = A._asJSObject(t);
      siteid = A._asString(t.value);
      t2 = type$.dynamic;
      out = A.LinkedHashMap_LinkedHashMap$_literal(["siteid", siteid, "address", siteid, "c", $.currTest], t2, t2);
      if (B.JSArray_methods.contains$1(A._setArrayType(["tmx4", "tmx3", "tmx1"], type$.JSArray_String), $.currTest)) {
        s = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#serial"));
        if (s == null)
          s = A._asJSObject(s);
        out.$indexSet(0, "serial", B.JSString_methods.padLeft$2(A._asString(s.value), 8, "0"));
      }
      if ($.currTest === "tmx3") {
        x3 = A._asString(A._asJSObject(A._asJSObject(t1.document).querySelectorAll('input[name="tmx3"]')).value);
        chv = [];
        s = A._asString(A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#channel_input")).value).split("-");
    ...
    starttest($event) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, button, t1, t, serial, z, t2, _this, path, out;
      var $async$starttest = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $event.preventDefault();
              button = A._asJSObjectQ($event.target);
              if (button == null)
                button = A._asJSObject(button);
              if (!A.validateInputs()) {
                A._asJSObject(init.G.window).alert("Please correct input and try again.");
                // goto return
                $async$goto = 1;
                break;
              }
              t1 = init.G;
              $async$goto = A._asStringQ(button.textContent) === "New test" ? 3 : 5;
              break;
            case 3:
              // then
              t = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#siteid"));
              ...
              t.focus();
              if ($.currTest === "tmx4") {
                serial = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#serial"));
                if (serial == null)
                  serial = A._asJSObject(serial);
            ...
            case 5:
              ...
              z = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#messages"));
              if (z == null)
                z = A._asJSObject(z);
              while (A._asJSObjectQ(z.firstElementChild) != null) {
                t2 = A._asJSObjectQ(z.firstElementChild);
                if (t2 != null)
                  t2.remove();
              }
              _this = A._asJSObject(A._asJSObject(t1.document).createElement("p"));
              _this.textContent = "OK. Starting test.";
              z.append(_this);
              path = A.Uri_parse("/cgi-bin/dotest.py");
              ...
              t2 = type$.String;
              $async$goto = 6;
              return A._asyncAwait(A.post(path, out, A.LinkedHashMap_LinkedHashMap$_literal(["Content-Type", "application/json"], t2, t2)), $async$starttest);
            case 6:
              // returning from await.
              t2 = $async$result.statusCode;
              if (t2 !== 200)
                A._asJSObject(t1.window).alert("Error starting test: " + t2);
            case 4:
              // join
            case 1:
              // return
    ...
    checkstatus() {
      var t1, rng, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, onError;
      if ($.$get$timer()._handle == null)
        $.timer = A.Timer_Timer(B.Duration_2000000, A.psctester__checkstatus$closure());
      $.$get$uuid();
      t1 = null;
      ...
      t1 = A.get(A.Uri_parse("control.json?uid=" + (t3 + t4 + t5 + t6 + "-" + t7 + t8 + "-" + t9 + t10 + "-" + t11 + t12 + "-" + t13 + t14 + t15 + t16 + t17 + t2[t1]))).then$1$1(new A.checkstatus_closure(), type$.Null);
      onError = new A.checkstatus_closure0();
      t2 = t1.$ti;
      t17 = $.Zone__current;
      if (t17 !== B.C__RootZone)
        onError = A._registerErrorHandler(onError, t17);
      t1._addListener$1(new A._FutureListener(new A._Future(t17, t2), 2, null, onError, t2._eval$1("_FutureListener<1,1>")));
    },
    sizeMessageBlock() {
      var t2, t3, messageContent, height, yavailable,
        t1 = init.G,
        msgs = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#messageblock"));
      if (msgs == null)
        msgs = A._asJSObject(msgs);
      t2 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#testing"));
      t2.toString;
      t3 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#top"));
      t3.toString;
      messageContent = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#messages"));
      if (messageContent == null)
        messageContent = A._asJSObject(messageContent);
      height = A._asInt(t2.clientHeight) + A._asInt(t3.clientHeight);
      yavailable = A._asInt(A._asJSObject(t1.window).innerHeight);
      A._asJSObject(msgs.style).top = "" + height;
      A._asJSObject(messageContent.style).height = "" + (yavailable - height - 60) + "px";
    },
    showmessages(aList) {
      var t2, t3, item, t4, starttime, t5, endtime, _this,
        t1 = init.G,
        liststart = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#messages"));
      if (liststart == null)
        liststart = A._asJSObject(liststart);
      while (A._asJSObjectQ(liststart.firstElementChild) != null) {
        t2 = A._asJSObjectQ(liststart.firstElementChild);
        if (t2 != null)
          t2.remove();
      }
      for (t2 = J.get$iterator$ax(aList), t3 = type$.List_dynamic; t2.moveNext$0();) {
        ...
        if (t3._is(item)) {
          ...
          t5 = Date.now();
          endtime = starttime._addMicroseconds$1(1000000 * A._asInt(t4.$index(item, 1)));
          B.JSInt_methods._tdivFast$1(endtime._microsecond + 1000 * (endtime._value - t5), 1000000);
          item = t4.$index(item, 0);
        }
        _this = A._asJSObject(A._asJSObject(t1.document).createElement("p"));
        _this.textContent = A._asStringQ(item);
        liststart.append(_this);
        A.sizeMessageBlock();
    ...
    checkstatus_closure0: function checkstatus_closure0() {
    },
            ...
            case 0:
              ...
              if (body != null)
                if (typeof body == "string")
                  ...
                  t1 = A.ArgumentError$('Invalid request body "' + A.S(body) + '".', null);
                  throw A.wrapException(t1);
                }
              $async$temp1 = A;
              $async$goto = 3;
  ...
  A.main_closure.prototype = {
    call$1(e) {
      ...
      $.currTest = "tmx5";
      A.enableTest();
      serial = A._asJSObjectQ(A._asJSObject(init.G.document).querySelector("#serial"));
      if (serial == null)
        serial = A._asJSObject(serial);
      serial.value = "";
      A.hide("#main");
  ...
  A.doFiles_closure.prototype = {
    call$1(e) {
      A._asJSObject(A._asJSObject(init.G.window).location).href = "/";
    },
    $signature: 1
  };
  ...
  A.doFiles_closure1.prototype = {
    call$1(e) {
      ...
      if (downloads == null)
        downloads = A._asJSObject(downloads);
      if (A._asString(downloads.value).length === 0) {
        e.preventDefault();
        e.stopPropagation();
        A._asJSObject(t1.window).alert("Please select files for download,");
      }
    },
    $signature: 1
  };
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.get(A.Uri_parse("/cgi-bin/initcontrolfile.py")), $async$call$1);
            case 2:
              // returning from await.
              A._asJSObject(init.G.window).alert("Control file reinitialized!");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  A.getVersions_closure.prototype = {
    call$1(resp) {
      ...
      this.pretag.textContent = A.encodingForContentTypeHeader(A._contentTypeForHeaders(resp.headers)).decode$1(resp.bodyBytes);
    },
    $signature: 3
  };
  A.getVersions_closure0.prototype = {
    call$1(resp) {
      ...
      t1 = this.s;
      if (t1 != null)
        t1.textContent = "Software versions: ( " + A.encodingForContentTypeHeader(A._contentTypeForHeaders(resp.headers)).decode$1(resp.bodyBytes) + " )";
    },
    $signature: 3
  };
  A.getAddresses_closure.prototype = {
    call$1(resp) {
      var j, t1, t2, t3, t4, address, t5;
      type$.Response._as(resp);
      j = type$.Map_dynamic_dynamic._as(B.C_JsonCodec.decode$2$reviver(A.encodingForContentTypeHeader(A._contentTypeForHeaders(resp.headers)).decode$1(resp.bodyBytes), null));
      for (t1 = type$.Iterable_String._as(j.get$keys()), t1 = t1.get$iterator(t1), t2 = this.p, t3 = init.G; t1.moveNext$0();) {
        t4 = t1.get$current();
        address = A._asStringQ(j.$index(0, t4));
        if (0 >= t4.length)
          return A.ioore(t4, 0);
        t5 = A.S(address);
        if (t4[0] === "w")
          t2.textContent = A.S(A._asStringQ(t2.textContent)) + " Wireless: " + t5 + " ";
        else
          t2.textContent = A.S(A._asStringQ(t2.textContent)) + " Wired: " + t5 + " ";
        A._asJSObject(t2.children);
        A._asJSObject(A._asJSObject(t3.document).createElement("br"));
      }
    },
    $signature: 3
  };
  A.showdate_closure.prototype = {
    call$1(resp) {
      var value, txt, t1;
      type$.Response._as(resp);
      value = A.DateTime_parse(A._asString(J.$index$asx(B.C_JsonCodec.decode$2$reviver(A.encodingForContentTypeHeader(A._contentTypeForHeaders(resp.headers)).decode$1(resp.bodyBytes), null), "datetime"))).toLocal$0();
  ...
  A.checkstatus_closure.prototype = {
    call$1(resp) {
      ...
      data = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      try {
        data = type$.nullable_Map_dynamic_dynamic._as(B.C_JsonCodec.decode$2$reviver(A.encodingForContentTypeHeader(A._contentTypeForHeaders(resp.headers)).decode$1(resp.bodyBytes), null));
      } catch (exception) {
        if (type$.FormatException._is(A.unwrapException(exception)))
          return;
        else
      ...
      if (J.$eq$(J.$index$asx(t1, "status"), "done") && data.$index(0, _s8_) != null) {
        ...
        if (msgs == null)
          msgs = A._asJSObject(msgs);
        A.sizeMessageBlock();
        if (A._asJSObjectQ(msgs.firstElementChild) != null) {
          _this = A._asJSObject(A._asJSObject(t1.document).createElement("p"));
          _this.textContent = "done";
          msgs.append(_this);
          _this.scrollIntoView();
          bell = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#bell"));
          if (bell != null)
            A._asJSObject(bell.play());
        }
        return;
      } else if (J.$eq$(data.$index(0, "status"), "tests in progress")) {
        A.show("#testing");
        A.hide("#main");
        A.hide("#serial_entry");
        A.showmessages(type$.List_dynamic._as(data.$index(0, "messages")));
        if ($.$get$timer()._handle == null)
          $.timer = A.Timer_Timer(B.Duration_2000000, A.psctester__checkstatus$closure());
        if (data.$index(0, "address") != null) {
          t1 = init.G;
          t = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#siteid"));
          if (t == null)
            t = A._asJSObject(t);
          t.value = A._asString(data.$index(0, "address"));
          t.disabled = true;
          A.show("#messageblock");
          A.rtMainEnable();
          button = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#testbutton"));
          if (button != null) {
            button.textContent = "Test in progress";
            button.disabled = true;
            A.show("#testbutton");
  ...
  A.checkstatus_closure0.prototype = {
    call$1(e) {
      var t1, button;
      A._asJSObject(e);
      t1 = init.G;
      A._asJSObject(t1.window).alert(A.S(e));
      button = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#testbutton"));
      if (button == null)
        button = A._asJSObject(button);
      button.disabled = false;
  ...
  (function installTearOffs() {
    ...
    _static_2(J, "_interceptors_JSArray__compareAny$closure", "JSArray__compareAny", 5);
    ...
    _instance(A._Completer.prototype, "get$completeError", 0, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 55, 0, 0);
    ...
    _static_2(A, "collection_ListBase__compareAny$closure", "ListBase__compareAny", 5);
    ...
    _static_1(A, "intl_helpers__deprecatedLocale$closure", "deprecatedLocale", 4);
    _static_1(A, "intl_helpers__shortLocale$closure", "shortLocale", 4);
    _static_2(A, "psctester__sitesort$closure", "sitesort", 5);
    _static_2(A, "psctester__datesort$closure", "datesort", 5);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Iterable, [A._CastIterableBase, A.EfficientLengthIterable, A.MappedIterable, A.WhereIterable, A.ExpandIterable, A.SkipIterable, A.WhereTypeIterable, A._KeysOrValues, A._AllMatchesIterable, A._StringAllMatchesIterable]);
    _inheritMany(A._CastIterableBase, [A.CastIterable, A.__CastListBase__CastIterableBase_ListMixin]);
    _inherit(A._EfficientLengthCastIterable, A.CastIterable);
    _inherit(A._CastListBase, A.__CastListBase__CastIterableBase_ListMixin);
    _inheritMany(A.Closure, [A.Closure2Args, A.Closure0Args, A.Instantiation, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._LinkedCustomHashMap_closure, A.DateTime_parse_parseIntOrZero, A.DateTime_parse_parseMilliAndMicroseconds, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.CanonicalizedMap_keys_closure, A.get_closure, A.post_closure, A.BaseRequest_closure0, A.BrowserClient_send_closure, A._bodyToStream_closure, A.ByteStream_toBytes_closure, A.MediaType_toString__closure, A.expectQuotedString_closure, A.DateFormat_dateTimeConstructor_closure, A.verifiedLocale_closure, A.verifiedLocale_closure0, A.verifiedLocale_closure1, A.Context_joinAll_closure, A.Context_split_closure, A._validateArgList_closure, A.Highlighter$__closure, A.Highlighter$___closure, A.Highlighter$__closure0, A.Highlighter__collateLines_closure, A.Highlighter__collateLines_closure1, A.Highlighter__collateLines__closure, A.Highlighter_highlight_closure, A._EventStreamSubscription_closure, A.main_closure, A.main_closure0, A.main_closure1, A.main_closure2, A.main_closure3, A.main_closure4, A.main_closure5, A.main_closure6, A.doFiles_closure, A.doFiles_closure0, A.doFiles_closure1, A.doFiles_closure2, A.enableTest_closure, A.rtMainEnable_closure, A.doMaintenance_closure, A.doMaintenance_closure0, A.doMaintenance_closure1, A.getVersions_closure, A.getVersions_closure0, A.getAddresses_closure, A.showdate_closure, A.checkstatus_closure, A.checkstatus_closure0]);
...
;
    ...
    B.Map_WsQuQ = new A.ConstantStringMap(B.Object_7NH, ["d", "ccc", "cccc", "LLL", "LLLL", "L", "M/d", "EEE, M/d", "LLL", "MMM d", "EEE, MMM d", "LLLL", "MMMM d", "EEEE, MMMM d", "QQQ", "QQQQ", "y", "M/y", "M/d/y", "EEE, M/d/y", "MMM y", "MMM d, y", "EEE, MMM d, y", "MMMM y", "MMMM d, y", "EEEE, MMMM d, y", "QQQ y", "QQQQ y", "HH", "HH:mm", "HH:mm:ss", "h\u202fa", "h:mm\u202fa", "h:mm:ss\u202fa", "h:mm\u202fa v", "h:mm\u202fa z", "h\u202fa z", "m", "mm:ss", "s", "v", "z", "zzzz", "ZZZZ"], type$.ConstantStringMap_String_String);
