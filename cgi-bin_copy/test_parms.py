...
Description of the test_parameters object:
    ...
    The key can have the following values:
        ...
        QFAM - Q family meters - Qbrick1, QBrick4, QBrick6
        ...
        A dictionary with the keys 'high' and 'low'
            ...
            Each entry in these dictionaries contains a list of tuples:
                Each tuple contains the following fields:
                    [0] - test time in seconds or timeout in seconds for Q family pulse testing
                    [1] - wait time for readings to settle - in seconds, or # of meter pulses for Q Family
...
test_parameters = {
    ...
    'QFAM': [                       # For Q Family (pulse test), the tuples mean: (Timeout_secs, max_pulses, percent uncertainty)
        [99,{'low': [
            (40,20,0.1)
            ],
           'high': [
